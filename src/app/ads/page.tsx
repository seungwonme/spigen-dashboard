...
export default function AdsPage() {
  ...
  useEffect(() => {
    setLoading(true);
    try {
      if (view === "campaigns") setData(getCampaigns(dateFrom, dateTo, adTypes, campaignStatus));
      else if (view === "attribution") setData(getAttributionByAsin(dateFrom, dateTo));
      else setData(getChannelComparison(dateFrom, dateTo, adTypes));
    } catch {
      setData([]);
    }
    setLoading(false);
